...
function t() {
  ...
  function E(e, t, n) {
    ...
    return '!' !== e[0].charAt(0)
      ...
      : { type: 'image', raw: n, href: r, title: i, text: U(t) };
  }
  var D = (function () {
      function e(e) {
        this.options = e || q;
      ...
      return (
          ...
          if (e) {
            for (
              var t,
                ...
                a = e[2],
                o = 1 < a.length,
                c = { type: 'list', raw: l, ordered: o, start: o ? +a.slice(0, -1) : '', loose: !1, items: [] },
                u = e[0].match(this.rules.block.item),
                p = !1,
                h = u.length,
                g = this.rules.block.listItemStart.exec(u[0]),
                f = 0;
              f < h;
              f++
            ) {
              ...
              (r = t.length),
                ...
                this.options.gfm &&
                  ((s = void 0),
                  (i = /^\[[ xX]\] /.test(t)) && ((s = ' ' !== t[1]), (t = t.replace(/^\[[ xX]\] +/, '')))),
                c.items.push({ type: 'list_item', raw: l, task: i, checked: s, loose: r, text: t });
            }
            return c;
          }
        }),
        ...
        (t.link = function (e) {
          ...
          if (t) {
            e = j(t[2], '()');
            -1 < e &&
              ((r = (0 === t[0].indexOf('!') ? 5 : 4) + t[1].length + e),
        ...
        (t.codespan = function (e) {
          ...
          if (t) {
            ...
            return (
              r && e && (n = n.substring(1, n.length - 1)), (n = U(n, !0)), { type: 'codespan', raw: t[0], text: n }
            );
          }
        }),
        (t.br = function (e) {
            ...
            n = t
              ? this.options.sanitize
                ? this.options.sanitizer
                  ...
                  : U(e[0])
                : e[0]
              : U(this.options.smartypants ? n(e[0]) : e[0]);
  ...
  var W = (function () {
      function n(e) {
        ...
        this.options.pedantic
          ? ((e.block = L.pedantic), (e.inline = N.pedantic))
          : this.options.gfm && ((e.block = L.gfm), this.options.breaks ? (e.inline = N.breaks) : (e.inline = N.gfm)),
      ...
      return (
          ...
          for (void 0 === t && (t = []), void 0 === n && (n = !0), e = e.replace(/^ +$/gm, ''); e; )
            if ((r = this.tokenizer.space(e))) (e = e.substring(r.raw.length)), r.type && t.push(r);
              ...
              (e = e.substring(r.raw.length)),
                r.type ? t.push(r) : (((l = t[t.length - 1]).raw += '\n' + r.raw), (l.text += '\n' + r.text));
        ...
        (r.inlineTokens = function (e, t, n, r) {
          ...
          for (; e; )
            if ((l || (a = ''), (l = !1), (i = this.tokenizer.escape(e)))) (e = e.substring(i.raw.length)), t.push(i);
              ...
              (e = e.substring(i.raw.length)), (i.tokens = this.inlineTokens(i.text, [], n, r)), t.push(i);
            else if ((i = this.tokenizer.autolink(e, M))) (e = e.substring(i.raw.length)), t.push(i);
            else if (n || !(i = this.tokenizer.url(e, M))) {
              if ((i = this.tokenizer.inlineText(e, r, F)))
                (e = e.substring(i.raw.length)), (a = i.raw.slice(-1)), (l = !0), t.push(i);
              else if (e) {
                      ...
                      p
                        ? 0 < g.tokens.length && 'text' === g.tokens[0].type
                          ? ((g.tokens[0].text = k + ' ' + g.tokens[0].text),
                            g.tokens[0].tokens &&
                              0 < g.tokens[0].tokens.length &&
                              'text' === g.tokens[0].tokens[0].type &&
                              (g.tokens[0].tokens[0].text = k + ' ' + g.tokens[0].tokens[0].text))
  ...
  function se(e, n, r) {
          ...
          'code' === n.type &&
            ...
            setTimeout(function () {
              s(n.text, n.lang, function (e, t) {
                return e
                  ? l(e)
                  : (null != t && t !== n.text && ((n.text = t), (n.escaped = !0)), void (0 === --a && l()));
              });
            }, 0));
        }),
        void (0 === a && l())
    ...
    try {
      ...
      if (((e.message += '\nPlease report this to https://github.com/markedjs/marked.'), n.silent))
        return '<p>An error occurred:</p><pre>' + re(e.message + '', !0) + '</pre>';
      throw e;
    }
  }
  return (
    (se.options = se.setOptions =
      function (e) {
